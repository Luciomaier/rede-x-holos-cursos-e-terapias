...
1. Ler, em ordem:
   ...
   - `_memoria/agenda.md` (pendências de gestão da Elis)
...
Agenda: [N pendências abertas — citar as 2-3 mais antigas ou urgentes]

Pronto. O que vamos fazer?
```

4. Se `agenda.md` não tiver pendências abertas, omitir a linha "Agenda".
